...
### Latest Release
The latest version of the extension is release v1.0.2. Refer the [CHANGE LOG](https://github.com/kartik-v/yii2-checkbox-x/blob/master/CHANGE.md) for details of various releases.
